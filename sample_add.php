                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-white mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="item_list.html">Item</a></li>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="photo" id="photo" class="form-control p-0 h-25" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="type" class="form-control custom-select" id="c" required>
